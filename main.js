...
let phone = await question(`\n[☣] Enter Your Phone Number\n\n\n\n`)
		...
		console.log(chalk.keyword("red")("[ The Code Bro ]"), code)
	}
	//=================================================//
	...
	sock.ev.on("connection.update", async (update) => {
		...
		if (connection == "connecting" || receivedPendingNotifications == false) {
			console.log("ᴛʀʏ ᴄᴏɴɴᴇᴄᴛ")
		} else if (connection == "open" || receivedPendingNotifications == true) {
			if (isActive?.status) {
				
						console.log(chalk.whiteBright("├"), chalk.keyword("red")("[ 𝐒𝐭𝐚𝐭𝐮𝐬 ]"), "𝐒𝐲𝐚𝐱𝐲𝐳 𝐈𝐬 𝐂𝐨𝐧𝐧𝐞𝐜𝐭")
					}
			...
			if (lastDisconnect.error == "Error: Stream Errored (unknown)") {
				...
				console.log(chalk.whiteBright("├"), chalk.keyword("red")("[ 𝐄𝐑𝐑𝐎𝐑 ]"), "Bad Session File, Please Delete Session and Scan Again")
				connectToWhatsApp()
			} else if (reason == DisconnectReason.connectionClosed) {
				console.log(chalk.whiteBright("├"), chalk.keyword("red")("[ 𝐄𝐑𝐑𝐎𝐑 ]"), "Connection closed, reconnecting....")
				connectToWhatsApp()
			} else if (reason == DisconnectReason.connectionLost) {
				console.log(chalk.whiteBright("├"), chalk.keyword("red")("[ 𝐄𝐑𝐑𝐎𝐑 ]"), "Connection Lost from Server, reconnecting....")
				connectToWhatsApp()
			} else if (reason == DisconnectReason.connectionReplaced) {
				console.log(chalk.whiteBright("├"), chalk.keyword("red")("[ 𝐄𝐑𝐑𝐎𝐑 ]"), "Connection Replaced, Another New Session Opened, Please Close Current Session First")
				sock.logout()
			} else if (reason == DisconnectReason.loggedOut) {
				console.log(chalk.whiteBright("├"), chalk.keyword("red")("[ 𝐄𝐑𝐑𝐎𝐑 ]"), "Device Logged Out, Please Scan Again And Run.")
				sock.logout()
			} else if (reason == DisconnectReason.restartRequired) {
				console.log(chalk.whiteBright("├"), chalk.keyword("red")("[ 𝐄𝐑𝐑𝐎𝐑 ]"), "Restart Required, Restarting....")
				connectToWhatsApp()
			} else if (reason == DisconnectReason.timedOut) {
				console.log(chalk.whiteBright("├"), chalk.keyword("red")("[ 𝐄𝐑𝐑𝐎𝐑 ]"), "Connection TimedOut, Reconnecting....")
				connectToWhatsApp()
			}
		}
	})
	...
	sock.ev.on("messages.upsert", async ({
		...
		try {
			...
			console.log(chalk.whiteBright("├"), chalk.keyword("red")("[ 𝐄𝐑𝐑𝐎𝐑 ]"), err)
		}
	})
	//=================================================//
